...
if(key){
  ...
  if(key == 19){
      ...
      if(Weight < 0){
        ...
        Weight = (((value - Zero)/389));
        
      }
      
      mystring = String(Weight);
   
      Serial.println();
      Serial.println("Weight: " + mystring + " g");
//      delay(100);
      String mystring;
      String tack = ""+Barcodes[0]+
      Barcodes[1]+
      Barcodes[2]+
      Barcodes[3]+
      Barcodes[4]+
...
//      Barcodes[11]+
//      Barcodes[12]+"\",";
//      String weigth= "\"weigth\": \""+ mystring + "\"";
//      String JSON_data = barcodes + weigth + "}";
